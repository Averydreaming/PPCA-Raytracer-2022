...
use crate::material::{Dielectric, Lambertian, Metal}; //各向同性的
use crate::ray::Ray;
...
fn write_color(pixel_color: RGBColor, samples_per_pixel: i32) -> [u8; 3] {
    ...
    b = (b * scale).sqrt();
    [
        (r.clamp(0.0, 0.999) * 255.999).floor() as u8,
        (g.clamp(0.0, 0.999) * 255.999).floor() as u8,
        (b.clamp(0.0, 0.999) * 255.999).floor() as u8,
    ]
}
/*
...
fn cornell_box() -> HittableList {
    ...
    */
    ...
    let aluminum = Arc::new(Metal::new(RGBColor::new(0.8, 0.85, 0.88), 0.0));
...
fn main() {
    ...
    for thread_id in 0..THREAD_NUMBER {
        ...
        lights.add(Arc::new(xz_rect::new(
            213.,
            343.,
            227.,
            332.,
        ...
        /* let lights = Arc::new(xz_rect::new(
            213.,
            343.,
            227.,
            332.,
                ...
                for y in line_beg..line_end {
                    for x in 0..IMAGE_WIDTH {
                        ...
                        for _i in 0..SAMPLES_PER_PIXEL {
                            ...
                            pixel_color +=
                                Ray::ray_color(r, background, &world, lights.clone(), MAX_DEPTH);
                        }
