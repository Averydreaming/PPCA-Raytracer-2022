...
fn cornell_box() -> HittableList {
    ...
    */
    ...
    objects.add(Arc::new(xz_rect::new(0.,555.,0.,555.,0., white.clone(),)));
    objects.add(Arc::new(xz_rect::new(0., 555., 0., 555., 555., white.clone(), )));
    objects.add(Arc::new(xy_rect::new(0., 555., 0., 555., 555., white.clone())));
