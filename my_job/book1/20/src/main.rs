...
fn main() {
    ...
    let material_center = Arc::new(Lambertian::new(RGBColor::new(0.1, 0.2, 0.5)));
    let material_left = Arc::new(Dielectric::new(1.5));
    let material_right = Arc::new(Metal::new(RGBColor::new(0.8, 0.6, 0.2), 0.0));
