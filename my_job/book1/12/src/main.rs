...
fn main() {
    ...
    let material_ground = Arc::new(Lambertian::new(RGBColor::new(0.8, 0.8, 0.0)));
    let material_center = Arc::new(Lambertian::new(RGBColor::new(0.7, 0.3, 0.3)));
    let material_left = Arc::new(Metal::new(RGBColor::new(0.8, 0.8, 0.8), 0.3));
    let material_right = Arc::new(Metal::new(RGBColor::new(0.8, 0.6, 0.2), 1.0));
